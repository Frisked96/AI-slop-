...
class SouthSectorLevel(Level):
    ...
    def generate_map(self, grid, room_centers, next_map_tile_pos, entry_direction=None, game_state=None):
        ...
        grid[2][self.width // 2] = CityCenterEntranceTile()
        
        # Fixed player spawn position for South Sector
        player_spawn_pos = (self.width // 2, 3) # Spawn just below 'C'
